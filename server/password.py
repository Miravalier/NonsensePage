...
def hash_password(password: str) -> bytes:
    ...
    return iterations.to_bytes(4, "big") + salt + hashlib.pbkdf2_hmac("sha256", password, salt, iterations)
...
def check_password(password: str, hashed_password: bytes) -> bool:
    ...
    given_hash = hashlib.pbkdf2_hmac("sha256", password, salt, iterations)
